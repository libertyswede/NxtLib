...
namespace NxtLib.Internal
{
    internal class AttachmentConverter
    {
        ...
        static AttachmentConverter()
        {
            ...
            attachmentFuncs.Add(TransactionSubType.MessagingPollCreation, value => new MessagingPollCreation(value));
            ...
            attachmentFuncs.Add(TransactionSubType.PaymentOrdinaryPayment, value => new OrdinaryPaymentAttachment(value));
