...
namespace NxtLib.AssetExchange
{
    public interface IAssetExchangeService
    {
        ...
        Task<AccountAssetsReply> GetAccountAssets(Account account, ulong? assetId = null, bool? includeAssetInfo = null, 
        ...
        Task<AssetDividendsReply> GetAssetDividends(ulong assetId, int? firstIndex = null, int? lastIndex = null,
