...
namespace NxtLib.AssetExchange
{
    public class AssetExchangeService : BaseService, IAssetExchangeService
    {
        ...
        public async Task<AccountAssetsReply> GetAccountAssets(Account account, ulong? assetId = null, 
            bool? includeAssetInfo = null, int? height = null, ulong? requireBlock = null, ulong? requireLastBlock = null)
        {
            var queryParameters = new Dictionary<string, string> {{Parameters.Account, account.AccountId.ToString()}};
