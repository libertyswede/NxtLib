...
namespace NxtLib.MonetarySystem
{
    ...
    {
        Task<CanDeleteCurrencyReply> CanDeleteCurrency(string accountId, ulong currencyId, ulong? requireBlock = null,
        ...
        Task<GetAccountExchangeRequestsReply> GetAccountExchangeRequests(string accountId, ulong currencyId,
        ...
        Task<CurrenciesReply> GetCurrenciesByIssuer(IEnumerable<string> accountIds, int? firstIndex = null,
        ...
        Task<TransactionCreatedReply> TransferCurrency(string recipientId, ulong currencyId, long units,
            CreateTransactionParameters parameters);
    }
}