...
namespace NxtLib.Phasing
{
    public interface IPhasingService
    {
        ...
        Task<AccountPhasedTransactionCountReply> GetAccountPhasedTransactionCount(Account account,
            ulong? requireBlock = null, ulong? requireLastBlock = null);

        Task<TransactionListReply> GetAccountPhasedTransactions(Account account, int? firstIndex = null,
            int? lastIndex = null, ulong? requireBlock = null, ulong? requireLastBlock = null);

        Task<TransactionListReply> GetAssetPhasedTransactions(ulong assetId, Account account = null,
            bool? withoutWhitelist = null, int? firstIndex = null, int? lastIndex = null, ulong? requireBlock = null,
            ulong? requireLastBlock = null);

        Task<TransactionListReply> GetCurrencyPhasedTransactions(ulong currencyId, Account account = null,
            bool? withoutWhitelist = null, int? firstIndex = null, int? lastIndex = null, ulong? requireBlock = null,
            ulong? requireLastBlock = null);
        ...
        Task<PhasingPollVoteReply> GetPhasingPollVote(ulong transactionId, Account account, ulong? requireBlock = null,
            ulong? requireLastBlock = null);
        ...
        Task<TransactionListReply> GetVoterPhasedTransactions(Account account, int? firstIndex = null,
            int? lastIndex = null, ulong? requireBlock = null, ulong? requireLastBlock = null);
    }
}